...
//
// An unknown environment id: the by-id actions return a bare NotFound(), which ASP.NET
// renders as ProblemDetails - no code, error or message. So `error` comes from the status
...
func TestJSONError_API404_NotFound(t *testing.T) {
