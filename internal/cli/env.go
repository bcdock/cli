...
func init() {
	...
	envCmd.AddCommand(envCreateCmd, envListCmd, envGetCmd, envCredentialsCmd, envDeleteCmd, envLogsCmd, envUsageCmd, envOpenCmd, envDownloadSymbolsCmd, envPublishCmd, envLaunchJsonCmd, envHibernateCmd, envResumeCmd, envWaitCmd)
